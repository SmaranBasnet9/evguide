...
function LoginForm() {
  ...
  const oauthCls = "flex w-full items-center justify-center gap-3 rounded-2xl border border-gray-200 bg-gray-50 px-5 py-3 text-sm font-medium text-gray-700 transition hover:bg-gray-100 hover:text-gray-900 disabled:opacity-60";

  return (
    <main className="min-h-screen bg-gray-50 px-6 py-16 text-gray-900">
      <div className="mx-auto w-full max-w-md rounded-2xl border border-gray-200 bg-white p-8 shadow-[0_8px_40px_rgba(0,0,0,0.08)]">
