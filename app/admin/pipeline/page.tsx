  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-1 text-3xl font-extrabold text-gray-900">Pipeline Board</h1>
      ...
      <div className="flex gap-4 overflow-x-auto pb-4">
        {PIPELINE_STAGES.map((stage) => {
          ...
          return (
            <div
              key={stage}
              className="min-w-[260px] flex-shrink-0 rounded-2xl border border-gray-200 bg-gray-50"
            >
              {/* Column header */}
              <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3">
                ...
                <span className="text-xs font-bold text-gray-500">{stageLeads.length}</span>
              </div>
