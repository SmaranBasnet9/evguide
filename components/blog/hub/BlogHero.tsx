    ...
    <section className="relative overflow-hidden border-b border-white/8 pt-32">
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8 lg:pb-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mx-auto mt-10 max-w-3xl rounded-[2rem] border border-white/10 bg-white/[0.04] p-2 shadow-[0_24px_80px_rgba(0,0,0,0.45)] backdrop-blur-xl">
            <label className="flex items-center gap-3 rounded-[1.4rem] border border-white/6 bg-[#111111]/80 px-5 py-4 text-left transition focus-within:border-emerald-400/30 focus-within:shadow-[0_0_0_1px_rgba(16,185,129,0.25)]">
                ...
                <button
                  ...
                  className={`rounded-full border px-4 py-2 text-sm font-medium transition duration-300 ${
                    active
                      ...
                      : "border-white/10 bg-white/[0.03] text-zinc-300 hover:border-emerald-400/25 hover:bg-white/[0.06] hover:text-white"
                  }`}
                >
                  {category}
                </button>
