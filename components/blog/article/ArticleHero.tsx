...
export default function ArticleHero({ hero }: ArticleHeroProps) {
  return (
    <section className="relative overflow-hidden border-b border-white/10 bg-surface-base pt-28 text-white">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 pb-16 sm:px-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(320px,0.9fr)] lg:px-8 lg:pb-20">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-white/50 sm:text-xl">
            {hero.subtitle}
          </p>

          <div className="mt-8 flex flex-wrap items-center gap-4 text-sm text-white/50">
            <span className="rounded-full border border-white/10 bg-white/[0.06] px-4 py-2 text-white/70">
              By {hero.author}
            </span>
        ...
        <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.06] shadow-[0_30px_80px_rgba(0,0,0,0.45)]">
