...
function Field({
  ...
  const cls = `w-full rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-900 placeholder:text-gray-400 focus:border-blue-500 focus:outline-none`;
  return (
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-10">
      ...
      <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        <h2 className="mb-6 text-base font-semibold text-gray-900">Basic Info</h2>
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-3 flex flex-col gap-2 md:flex-row md:items-center">
              <input
                ...
                className="w-full text-sm text-gray-600 file:mr-4 file:rounded-xl file:border-0 file:bg-blue-50 file:px-4 file:py-2 file:font-semibold file:text-blue-700 hover:file:bg-blue-100"
              />
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-900 focus:border-blue-500 focus:outline-none"
            >
          ...
          <div>
            <label className="mb-1.5 block text-sm font-medium text-gray-700">Body Type</label>
            <select
              name="body_type"
          ...
          <div>
            <label className="mb-1.5 block text-sm font-medium text-gray-700">Badge Tag (optional)</label>
            <select
              name="badge"
      ...
      {/* Performance */}
      <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        <h2 className="mb-6 text-base font-semibold text-gray-900">Performance</h2>
        <div className="grid gap-5 md:grid-cols-2">
      ...
      {/* Battery & Charging */}
      <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        <h2 className="mb-6 text-base font-semibold text-gray-900">Battery &amp; Charging</h2>
        <div className="grid gap-5 md:grid-cols-2">
      ...
      {/* Dimensions & Features */}
      <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        <h2 className="mb-6 text-base font-semibold text-gray-900">Dimensions &amp; Features</h2>
        <div className="grid gap-5 md:grid-cols-2">
