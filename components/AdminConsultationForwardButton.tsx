  ...
  return (
    <div className="mt-2 space-y-2">
      ...
      <input
        ...
        className="w-56 rounded-lg border border-gray-200 px-2.5 py-1.5 text-xs text-gray-700 focus:border-purple-400 focus:outline-none focus:ring-1 focus:ring-purple-200"
      />
      <button
        type="button"
        onClick={forward}
