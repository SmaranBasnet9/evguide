...
export default function PremiumCompareCTA({ modelA, modelB, onReset }: PremiumCompareCTAProps) {
  return (
    <section className="bg-[#0B0B0B] py-16 pb-32">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-gradient-to-br from-zinc-900 to-[#0A0A0A] p-8 text-center shadow-2xl md:p-14">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-12 border-t border-white/5 pt-12">
              <p className="mb-6 text-zinc-500">Still weighing your options?</p>
              <button
                onClick={onReset}
